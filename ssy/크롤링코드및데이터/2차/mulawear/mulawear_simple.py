...
def get_href(xcode, gender, type_):
    ...
    while True:
        ...
        for li in ul:
            ...
            with open(f'./mulawear_{gender}_{type_}_href_images.csv', 'a') as csvfile:
...
for xcode in xcode_list:
    ...
    file = './mulawear_{gender}_{type_}_href_images.csv'
    if os.path.isfile(file):
        os.remove(file)
    get_href(xcode, gender, type_)